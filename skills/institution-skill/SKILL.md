...
```bash
curl -sS -G "http://10.1.132.21:8001/api/v1/intel/university/research" \
...
```bash
curl -sS -G "http://10.1.132.21:8001/api/v1/institutions/search" \
