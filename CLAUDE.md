...
中关村人工智能研究院信息监测系统。181 信源（138 启用）× 10 维度，6 种模板爬虫 + 11 个自定义 Parser，v1 API 33 端点（含 intel 业务智能 13 端点 + 项目库 6 端点）。
...
├── scholars/{group}/{source_id}/latest.json           # 学者数据（特殊存储位置）
├── scholars/institutions.json                          # 机构数据
├── scholars/events.json                                # 事件数据
