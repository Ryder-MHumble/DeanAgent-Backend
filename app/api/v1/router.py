...
from app.api.v1 import articles, dimensions, faculty, health, llm_tracking, sentiment, sources
...
v1_router.include_router(faculty.router, prefix="/faculty", tags=["faculty"])
