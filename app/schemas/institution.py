...
class InstitutionHierarchyOrganization(BaseModel):
    ...
    entity_type: str | None = Field(default=None, description="实体类型（organization）")
    region: str | None = Field(default=None, description="地域（国内 | 国际）")
